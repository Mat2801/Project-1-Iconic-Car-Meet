...
- [Font Awesome](https://fontawesome.com/) - Used to style the social media links on the footer and the call to action button on the landing image.
- [Google Fonts](https://fonts.google.com/) - Used to add fonts Oswold and Montserrat.
- [BeFunky](https://www.befunky.com/) - Used to edit pictures. 
- [Unsplash](https://unsplash.com/images/stock/non-copyrighted) - Used for images on the forms.
